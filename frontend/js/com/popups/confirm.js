...
export class ConfirmPopup extends BasePopup {
  ...
  static destroy () {
    return BasePopup.destroy('adb-confirm-popup')
  }
    ...
    return html`
      <div class="bg-default px-5 py-4">
        ...
        <div class="flex justify-between items-center">
          <adb-button @click=${this.onReject} label="Cancel"></adb-button>
          <adb-button primary @click=${this.onResolve} label="Okay"></adb-button>
        </div>
      </div>
    `
  }
...
customElements.define('adb-confirm-popup', ConfirmPopup)