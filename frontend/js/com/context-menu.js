...
export function destroy (value) {
  const el = document.querySelector('adb-context-menu')
  if (el) {
...
function onClickAnywhere (e) {
  if (!findParent(e.target, el => el.tagName === 'adb-CONTEXT-MENU')) {
...
customElements.define('adb-context-menu', ContextMenu)