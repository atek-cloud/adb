...
customElements.define('adb-button', Button)
...
export class ButtonGroup extends LitElement {
  ...
  onSlotChange (e) {
    const childNodes = Array.from(e.target.assignedNodes({flatten: true})).filter(el => el.tagName === 'ADB-BUTTON')
...
customElements.define('adb-button-group', ButtonGroup)
