...
class AppRoot extends LitElement {
  ...
  render () {
    ...
    switch (this.currentPath) {
      case '/':
        return html`<adb-main-view id="view" current-path=${this.currentPath} current-qp=${this.currentQP}></adb-main-view>`
    }
    if (this.currentPath.startsWith('/p/db/')) {
      return html`<adb-db-view id="view" current-path=${this.currentPath} current-qp=${this.currentQP}></adb-db-view>`
    }
    return html`
...
customElements.define('adb-root', AppRoot)